...
# Load in the data
df = pd.read_csv("./workdir/winequality-red.csv")
...
with open("./workdir/metrics.txt", 'w') as outfile:
...
plt.tight_layout()
plt.savefig("./workdir/feature_importance.png",dpi=120)
plt.close()
...
plt.tight_layout()
plt.savefig("./workdir/residuals.png",dpi=120)
